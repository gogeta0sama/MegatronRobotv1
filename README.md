![Megatron](https://telegra.ph/file/90dd63556b2050b72adeb.jpg)
# Megatron Robot 
...
Can be found on telegram as [Megatron](https://t.me/Megatron_Robot).

The Support group can be reached out to at [Megatron Support](https://t.me/MegatronSupportGroup), where you can ask for help about @MegatronSupportGroup, discover/request new features, report bugs, and stay in the loop whenever a new update is available. 

News channel as at [Megatron Update News](https://t.me/MegatronUpdate) 

## How to setup/deploy.

[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/gogeta0sama/MegatronRobot.git)

Note: This instruction set is just a copy-paste from Marie, note that [Megatron Support](https://t.me/MegatronSupportGroup) aims to handle support for @SaitamaRobot and not how to set up your own fork. If you find this bit confusing/tough to understand then we recommend you ask a dev, kindly avoid asking how to set up the bot instance in the support chat, it aims to help our own instance of the bot and not the forks.
